...
<!-- Badges -->
[![Netlify Status](https://api.netlify.com/api/v1/badges/8f38761f-77fb-46c6-8675-b5b08e19bf36/deploy-status)](https://app.netlify.com/sites/electromagnetism-book/deploys)
[![License: CC BY-NC 4.0](https://img.shields.io/badge/License-CC%20BY--NC%204.0-lightgrey.svg)](https://creativecommons.org/licenses/by-nc/4.0/)
[![Physics: Theoretical](https://img.shields.io/badge/Physics-Theoretical-blueviolet)](https://en.wikipedia.org/wiki/Theoretical_physics)
...
```mermaid
graph TD
    A[Classical Phenomena] -->|Relativity Perspective| B(Relativistic Effects of EM)
    B -->|4D Spacetime| C[EM Tensor Fμν]
    D[Quantum Mechanics] -->|Field Theory| E(Quantum Field Theory QFT)
    E -->|Local Gauge Symmetry U1| F[Birth of Gauge Field Aμ]
    F -->|Covariant Derivative| G[Charge & Interaction Vertex]
    C -->|Tensor Concerto| H[Covariant Maxwell Equations]
    F -->|Geometry Basis| H
